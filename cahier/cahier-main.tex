...
We begin with a line described parametrically.
\begin{compactitem}
\item[a)] Find a normal vector for the line described parametrically by
\[
...
We begin with a line described by an equation.
\begin{compactitem}
\item[a)] Find a normal vector to the line defined by the equation $-3x + y =7$.
\item[b)] Plot this line and the normal vector you found.
\end{compactitem}
\end{task}
