...
\typeout{Subsection  Discussion}
\typeout{************************************************}
\subsection[Discussion]{Discussion}\label{subsection-38}
\typeout{************************************************}
\typeout{Subsection  Sage and xxx}
\typeout{************************************************}
\subsection[Sage and xxx]{Sage and xxx}\label{subsection-39}
\typeout{************************************************}
\typeout{Subsection  Exercises}
\typeout{************************************************}
...
\typeout{Subsection  Sage and xxx}
\typeout{************************************************}
\subsection[Sage and xxx]{Sage and xxx}\label{subsection-44}
\typeout{************************************************}
\typeout{Subsection  Exercises}
\typeout{************************************************}
