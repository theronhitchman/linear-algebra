...
If you prefer to think about the whole vector $\gamma(t)$, rather than just its head, it helps to imagine that vector sweeping through space as time goes one. The heads of the vectors still trace out the line, but the tails of the vectors all stay at the origin.
